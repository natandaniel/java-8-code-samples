...
class BinaryOperatorMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("Adding treasure bags; expecting 30 gold coins; result : " + sumTreasureBags.apply(tenGoldCoins, twentyGoldCoins).gold + " gold coins");
		...
		System.out.println("Comparing treasure bags; expecting bag with 10 gold coins; result : bag with " + smallestTreasureBag.apply(tenGoldCoins, twentyGoldCoins).gold + " gold coins");
		...
		System.out.println("Comparing treasure bags; expecting bag with 10 gold coins; result : bag with " + biggestTreasureBag.apply(tenGoldCoins, twentyGoldCoins).gold + " gold coins");		
	}
}
