...
In this project, I illustrate the effectiveness of lambdas when used to implement **a custom functional interface** as opposed to the traditional **_anonymous class_**. The functional interface provides an abstract method **to say hello**.
